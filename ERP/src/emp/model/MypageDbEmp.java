...
public class MypageDbEmp {
	...
	public MypageDbEmp(int empno, String ename, int deptno) {
		this.empno = empno;
		this.ename = ename;
		this.deptno = deptno;
	}
	public MypageDbEmp(String ename,int empno) {
		this.empno = empno;
		this.ename = ename;
	}
	//생성자
	//기본생성자 - 혹시나 부분적으로 필요할 때 객체를 만들어 담기위해 만듬
	public MypageDbEmp(int empno, String ename, String emppwd, int deptno, String level, String email,
	...
	public MypageDbEmp(int deptno, String deptname) {
		this.deptno = deptno;
		this.deptname = deptname;
	}
	public MypageDbEmp(int empno,String ename,int deptno,String deptname,String level,int grade) {
		this.empno =empno;
		this.ename =ename;
		this.deptno =deptno;
		this.deptname =deptname;
	...
	public MypageDbEmp(int empno, String ename, String emppwd, int deptno, String deptname, String level, String email,
			String tel, Date hiredate,int sal, int grade) {
		this.empno = empno;
		this.ename = ename;
		this.emppwd = emppwd;
	...
	public MypageDbEmp(String dname) {
	...
	public String toString() {
		return "Emp [empno=" + empno + ", ename=" + ename + ", emppwd=" + emppwd + ", deptno=" + deptno + ", deptname="
				+ deptname + ", level=" + level + ", email=" + email + ", tel=" + tel + ", hiredate=" + hiredate
	...
	//비밀번호 일치하는지 확인하는 메소드
		...
		public boolean matchDno(int Deptno) {
		...
		public boolean matchLevel(String Level) {
